...
var PtyManager = class {
  constructor() {
    this.proc = null;
    this.stdoutDecoder = new import_string_decoder.StringDecoder("utf8");
    this.stderrDecoder = new import_string_decoder.StringDecoder("utf8");
    this.onData = null;
    this.onError = null;
    this.onExit = null;
  }
  ...
  start(cwd, extraFlags, cols, rows) {
    var _a, _b;
    if (this.isRunning) this.kill();
    const isWindows = process.platform === "win32";
    const PTY_SCRIPT_B64 = "";
    ...
    fs.writeFileSync(ptyPath, ptyScript, { mode: 493 });
    ...
    this.proc = (0, import_child_process.spawn)(python, args, {
      cwd,
      env: shellEnv,
    ...
    (_a = this.proc.stdout) == null ? void 0 : _a.on("data", (data) => {
      var _a2;
      (_a2 = this.onData) == null ? void 0 : _a2.call(this, this.stdoutDecoder.write(data));
    });
    (_b = this.proc.stderr) == null ? void 0 : _b.on("data", (data) => {
      var _a2;
      (_a2 = this.onError) == null ? void 0 : _a2.call(this, this.stderrDecoder.write(data));
    });
    this.proc.on("close", (code) => {
      var _a2;
      this.proc = null;
      (_a2 = this.onExit) == null ? void 0 : _a2.call(this, code);
    });
    this.proc.on("error", (err) => {
      var _a2;
      (_a2 = this.onError) == null ? void 0 : _a2.call(this, `\r
Failed to start process: ${err.message}\r
`);
    });
  }
  write(data) {
    var _a, _b;
    (_b = (_a = this.proc) == null ? void 0 : _a.stdin) == null ? void 0 : _b.write(Buffer.from(data, "utf8"));
  }
  resize(cols, rows) {
    var _a, _b;
    (_b = (_a = this.proc) == null ? void 0 : _a.stdin) == null ? void 0 : _b.write(Buffer.from(`\x1B]RESIZE;${cols};${rows}\x07`, "utf8"));
  }
  kill() {
    if (this.proc) {
  ...
  detectPython(isWindows) {
    if (!isWindows) return "python3";
    try {
      (0, import_child_process2.execSync)("py --version", { stdio: "ignore", timeout: 2e3 });
      return "py";
    } catch (e) {
    }
    try {
      const out = (0, import_child_process2.execSync)("where.exe python", { encoding: "utf8", timeout: 2e3 });
  ...
  getLoginShellEnv(shell, fallback) {
    var _a;
    try {
      const out = (0, import_child_process2.execSync)(`${shell} -lic 'echo "__PATH__"; echo "$PATH"'`, {
        encoding: "utf8",
        timeout: 3e3
      });
      const shellPath = (_a = out.split("__PATH__\n")[1]) == null ? void 0 : _a.trim().split("\n")[0];
...
// src/terminal-view.ts
var VIEW_TYPE = "opencode-terminal";
...
`;
  ...
  resolveCwd() {
    ...
    return (_a = this.app.vault.adapter.basePath) != null ? _a : process.cwd();
  }
  async startSession(cwd) {
    var _a, _b, _c, _d, _e;
    const workingDir = cwd != null ? cwd : this.resolveCwd();
    const cols = (_b = (_a = this.term) == null ? void 0 : _a.cols) != null ? _b : 80;
    const rows = (_d = (_c = this.term) == null ? void 0 : _c.rows) != null ? _d : 24;
    const flags = [];
    ...
    this.pty.onError = (data) => {
      var _a2;
      (_a2 = this.term) == null ? void 0 : _a2.write(`\x1B[31m${data}\x1B[0m`);
    };
    this.pty.onExit = (_code) => {
      var _a2;
      (_a2 = this.term) == null ? void 0 : _a2.write(
...
`);
  ...
  showRestartButton(cwd) {
    ...
    btn.addEventListener("click", async () => {
      var _a;
      btn.remove();
      (_a = this.term) == null ? void 0 : _a.clear();
  ...
  async restartSession() {
    ...
    this.pty.kill();
    (_a = this.term) == null ? void 0 : _a.clear();
    (_b = this.termHost) == null ? void 0 : _b.querySelectorAll(".vault-terminal-restart").forEach((el) => el.remove());
    await this.startSession();
  }
  toggleYolo() {
...
var OpenCodeSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("Default working directory").setDesc("Leave empty to use vault root. Used for new sessions.").addText(
      (text) => text.setPlaceholder("/path/to/dir").setValue(this.plugin.data.defaultWorkingDir || "").onChange(async (value) => {
        this.plugin.data.defaultWorkingDir = value.trim() || null;
        await this.plugin.saveData(this.plugin.data);
      })
    );
    new import_obsidian2.Setting(containerEl).setName("Additional flags").setDesc("Extra flags appended to the opencode command on startup.").addText(
      (text) => text.setPlaceholder("--flag value").setValue(this.plugin.data.additionalFlags || "").onChange(async (value) => {
        this.plugin.data.additionalFlags = value.trim() || null;
        await this.plugin.saveData(this.plugin.data);
      })
    );
    new import_obsidian2.Setting(containerEl).setName("Color theme").setDesc("Terminal ANSI color palette.").addDropdown(
      (drop) => drop.addOption("obsidian", "Match Obsidian theme").addOption("default", "Terminal default").setValue(this.plugin.data.ansiTheme).onChange(async (value) => {
        this.plugin.data.ansiTheme = value;
        await this.plugin.saveData(this.plugin.data);
      })
    );
  }
...
function registerContextMenus(plugin) {
  plugin.registerEvent(
    plugin.app.workspace.on("file-menu", (menu, file) => {
      if (!(file instanceof import_obsidian3.TFolder)) return;
      menu.addItem((item) => {
        item.setTitle("Open OpenCode here").setIcon("bot").onClick(async () => {
  ...
  plugin.registerEvent(
    plugin.app.workspace.on("editor-menu", (menu, editor) => {
      ...
      if (!selection) return;
      menu.addItem((item) => {
        item.setTitle("Send to OpenCode").setIcon("bot").onClick(async () => {
          const view = await ensureTerminalView(plugin);
          view == null ? void 0 : view.sendInput(selection);
        });
      });
    })
  );
...
function getBasePath(plugin) {
  var _a;
  return (_a = plugin.app.vault.adapter.basePath) != null ? _a : "";
}
...
var OpenCodePlugin = class extends import_obsidian4.Plugin {
  ...
  async onload() {
    ...
    this.addCommand({
      ...
      callback: () => {
        var _a;
        return (_a = this.getActiveTerminal()) == null ? void 0 : _a.restartSession();
      }
    });
    this.addCommand({
      id: "toggle-yolo",
      ...
      callback: async () => {
        ...
        if (!view) {
          new import_obsidian4.Notice("No active OpenCode session.");
          return;
        }
        const enabled = view.toggleYolo();
        new import_obsidian4.Notice(`YOLO mode ${enabled ? "enabled" : "disabled"}. Restarting\u2026`);
    ...
    this.addCommand({
      ...
      callback: async () => {
        ...
        const basePath = (_a = this.app.vault.adapter.basePath) != null ? _a : "";
        const dir = (file == null ? void 0 : file.parent) ? `${basePath}/${file.parent.path}` : basePath;
